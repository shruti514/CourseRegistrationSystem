...
/**
 * Responsibility of the class is perform CRUD operations on the entities
 * involved in the system To be able to perform operations mentioned in the
 * class, Entities should implement Serializable interface .
 */
abstract class GenericDAO<T extends Serializable> {
	 ...
	 *
	 * @param id
	 *            primary key of an entity to be searched
	 * @return returns an entity instance or null if the entity with given
	...
	public T findById(Long id) {
		...
		try {
			...
			logger.error("Error occurred finding an entity of type:{}",
	...
	/**
	 * Find all entities Returns a list of entities of any given type.
	 * 
	 ...
	 * 
	 * @param updatedObject
	 *            an entity object to be updated/merged in db
	...
	public T update(T updatedObject) {
		...
		try {
			...
			logger.error("Error updating object of type: {}", clazz.getName(),
					exception);
			throw exception;
		}
	 ...
	 * 
	 * @param newObject
	 *            an entity object to be stored in db
	 */
	@Transactional
	public void save(T newObject) {
		...
		try {
			...
			logger.error("Error saving object of type: {}", clazz.getName(),
					exception);
			throw exception;
		}
	 ...
	 * 
	 * @param entities
	 *            entity objects object to be stored in db
	 */
	 ...
	 * 
	 * @param ids
	 *            primary keys of the entity objects to be deleted
	 */
	...
	public void delete(T toDelete) {
		...
		try {
			...
			logger.error("Error deleting object of type: {}", clazz.getName(),
					exception);
			throw exception;
		}
	...
	public void delete(Long id) {
		...
		if (toDelete != null) {
			...
			logger.debug("Done deleting a object of type: {} with id: {}",
					clazz.getName(), id);
		}
