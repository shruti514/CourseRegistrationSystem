...
abstract class GenericDAO<T extends Serializable> {
	...
	/**
	 * Returns a list of entities of any given type. As different entities will
	 * have different display orders so the method is abstract and its up to
	 * entities to pull all the data in the order they want
	 */
	 ...
	 *
	 * @param updatedObject
	 *            an entity object to be updated in db
